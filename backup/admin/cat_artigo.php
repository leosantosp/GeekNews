...
function ConfirmaExclusao(id) {
  ...
  location="class/control_cat_artigo.php?var="+id+"&control=delete";
...
<?php require 'menu.php';?>
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
					 <h1 class="page-header">Cat_Artigo</h1>
 ...
 <div class="container-fluid" style="background-color:#FFFFFF;">
		...
		<br/>
		<form method="post" action="class/control_cat_artigo.php" enctype="multipart/form-data">
			<br/>
		...
		<div class="col-lg-12 br" >
			...
			<?php
				...
				{	
					$search = $_POST['search'];
					$resultado = mysqli_query($conn,"SELECT * FROM `cat_artigo` WHERE `texto` LIKE '%$search%' OR `nome` LIKE '%$search%' order by `id`");		
				}else{
					$sql = "SELECT * FROM `cat_artigo` order by `id`";
			...
			?>
				<tr>
					...
					<td>
						<form method="post" action="cat_artigoalterar.php">
