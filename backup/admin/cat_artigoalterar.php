...
<?php require 'menu.php';?>
    ...
    <form class="col-sm-12 text-center" action="class/control_cat_artigo.php" method="post" enctype='multipart/form-data'>
...
<fieldset class='col-sm-12 col-xs-12 br'>
					<div class="form-group col-xs-12 col-lg-3 col-md-3 col-sm-3">
						...
						<div class="">
							<input type="text" name="titulo" value='<?php echo $row['nome']; ?>' class="form-control" required />
						</div>
					</div>	
