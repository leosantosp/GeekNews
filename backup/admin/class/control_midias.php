...
class estrutura{
	...
	public function insert()
	{
		...
		$nome = $_POST['nome'];
		$url = $_POST['url'];
		mysqli_query($this->main,"INSERT INTO `midias`(`id`, `nome`,`url`) VALUES ('','$nome','$url')");

		echo "<meta http-equiv='refresh' content='0;URL=../midias.php'><script>alert('Inserido com sucesso!');</script>";
	...
	public function update()
	{
		...
		$sql = "UPDATE midias SET nome = '$nome', url = '$url' WHERE id = '$id' ";
		mysqli_query($this->main,$sql);

		echo "<meta http-equiv='refresh' content='0;URL=../midias.php'><script>alert('Alterado com sucesso!');</script>";
	}
	...
	public function delete()
	{
		...
		echo "<meta http-equiv='refresh' content='0;URL=../midias.php'><script>alert('Categoria excluída!');</script>";
	}
