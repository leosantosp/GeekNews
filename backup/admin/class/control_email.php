...
class estrutura{
	...
	public function insert()
	{
		...
		$nome = $_POST['nome'];
		mysqli_query($this->main,"INSERT INTO `email`(`id`, `nome`) VALUES ('','$nome')");

		echo "<meta http-equiv='refresh' content='0;URL=../email.php'><script>alert('Inserido com sucesso!');</script>";
	...
	public function update()
	{
		...
		$sql = "UPDATE email SET nome = '$nome' WHERE id = '$id' ";
		mysqli_query($this->main,$sql);

		echo "<meta http-equiv='refresh' content='0;URL=../email.php'><script>alert('Alterado com sucesso!');</script>";
	}
	...
	public function delete()
	{
		...
		echo "<meta http-equiv='refresh' content='0;URL=../email.php'><script>alert('Excluído com sucesso!');</script>";
	}
