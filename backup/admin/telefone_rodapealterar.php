...
function ConfirmaExclusao(id) {
  ...
  location="class/control_telefone_artigo.php?var="+id+"&control=delete";
...
<?php require 'menu.php';?>
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
				<h1 class="page-header"><h1>Telefone&Footer</h1>
    ...
    <form class="col-sm-12 text-center" action="class/control_telefone_rodape.php" method="post" enctype='multipart/form-data'>
...
$sql = "SELECT * FROM telefone_rodape WHERE id= $id ";
