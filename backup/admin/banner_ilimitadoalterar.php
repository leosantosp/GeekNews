...
<?php require 'menu.php';?>
    ...
    <form class="col-sm-12 text-center" action="class/control_banner_ilimitado.php" method="post" enctype='multipart/form-data'>
...
<fieldset class='col-sm-12 col-xs-12 br'>
					<div class="form-group col-xs-12 col-lg-3 col-md-3 col-sm-3">
						...
						<div class="">
							<input type="text" name="titulo" value='<?php echo $row['url']; ?>' class="form-control" required />
						</div>
					</div>	
...
<?php
    echo "
    <img src='".$dir.$row['nome']."' class='img-responsive'/>
    <input name='foto' type='hidden' value='".$row['nome']."' />
