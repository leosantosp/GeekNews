...
function ConfirmaExclusao(id) {
  ...
  location="class/control_banner_ilimitado.php?var="+id+"&control=delete";
...
<?php require 'menu.php';?>
        ...
        <div id="page-wrapper">
            <div class="row">
				...
				<h1 class="page-header">Banner</h1>
                    <h3 class="page-header">Publicidade</h3>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
 ...
 <div class="container-fluid" style="background-color:#FFFFFF;">
		...
		<br/>
		<form method="post" action="class/control_banner_ilimitado.php" enctype="multipart/form-data">
			<br/>
		...
		<div class="col-lg-12 br" >
			...
			<?php
				...
				{	
					$search = $_POST['search'];
					$resultado = mysqli_query($conn,"SELECT * FROM `imagem` WHERE `nome` LIKE '%$search%' OR `url` LIKE '%$search%' order by `id`");		
				}else{
			...
			?>
				<tr>
					...
					<td>
						<img src="images/<?php echo  $retorno['nome']; ?>" width="200" alt=""/>
					</td>
					<td>
					...
					<td>
						<form method="post" action="banner_ilimitadoalterar.php">
