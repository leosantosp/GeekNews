...
$ban = new banner();
    ...
    <section class="container-fluid">
      <section class="row">
<form action="class/control_banner.php" method="post" enctype='multipart/form-data'>
        <h3 class="col-sm-12 text-center">
		 Tamanho recomendado: 908x728
		</h3>
                       <?php
                $dir="images/";
				...
				<div class="clearfix"></div>
                    ...
                    <div class="col-xs-12 text-left">
                     ...
                     <input class="col-sm-6  col-xs-12 form-control" type="url" name="url" placeholder="Copie e cole a URL/Link da propaganda"  required/>
