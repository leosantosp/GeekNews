          ...
          <div class="col-sm-8 col-xs-12">
            <div class="row">
              <div class="col-sm-6 col-xs-12">
                ...
                <p><label>Preço: </label> R$ <?php echo (isset($row['preco'])) ?  str_replace('.', ",",$row['preco'] ): '';?></p>  
                <p>
                  <label>Estoque: </label> <?php echo (isset($row['estoque']))?$row['estoque']:'';?>
                </p>
              </div>
              <div class="col-sm-6 col-xs-12">
                <p>
                  ...
                  <?php echo ($row['visibilidade'])?'SIM':'NÃO';?>
                </p>
                <p>
                  <label>
                    Promovido: 
                  </label>
                  <?php echo ($row['promocao'])?'SIM':'NÃO';?>
                </p>
                <p>
                  <label>
                    Destacado: 
                  </label>
                  <?php echo ($row['destaque'])?'SIM':'NÃO';?>
                </p>
              </div>
            </div>
          </div>
          <div class="col-sm-4 col-xs-12">
            <a class='btn btn-warning pull-right' href='produto_adm_tag.php?id=<?php echo $row['id']?>'>Ver / Alterar</a>
          </div>
